const welcomeUser = () => {
    let askName = prompt('¡Welcome to Pasapalabra game (Spanish version)!\n\n¿What\'s your name?');
    userName = askName;
    ...
    do {
        for (let i = 0; i < questions.length; i++) {
            ...
            if (questions[i].status == 0) {            
                let questionToUser = prompt(questions[i].question).toLowerCase();
                ...
                switch(questionToUser) {
                    ...
                    case "end":
                        ...
                        break;
                    default:
                        console.log(`Your answer has been: ${userAnswer.toUpperCase()}\n\nThe correct answer is: ${questions[i].answer.toUpperCase()}\n\nNext question`)
                        alert(`¡WRONG ANSWER!`)
...
const finalGame = () => {
    if (points === 26) {
        console.log(`¡Congratulations, ${userName}! See below your results.\n\nRESULTS\n‾‾‾‾‾‾‾\n\nAnswered questions: ${answeredQuestions}\nCorrect questions: ${points}\nWrong questions: ${errors}`);
        ranking();
        alert("¡YOU'VE WON THE GAME!");
    } else if (stopGame === true) {
        console.log(`${userName}, you decided to end the game.\n\nYou got ${answeredQuestions} questions right.`);
        alert("¡STOPPED GAME!");
    } else if (stopTime === true) {
        console.log(`¡Times up, ${userName}! See below your results.\n\nRESULTS\n‾‾‾‾‾‾‾\n\nAnswered questions: ${answeredQuestions}\nCorrect questions: ${points}\nWrong questions: ${errors}`);
        ranking();
        alert("¡TIMES UP!");
    } else {
        console.log(`¡Game over, ${userName}! See below your results.\n\nRESULTS\n‾‾‾‾‾‾‾\n\nAnswered questions: ${answeredQuestions}\nCorrect questions: ${points}\nWrong questions: ${errors}`);
        alert("¡GAME OVER!");
    }
};
